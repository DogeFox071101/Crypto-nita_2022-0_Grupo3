        ...
        <main class="p-2 mt-4">
            <div>
                ...
                <div class="row col-5 mx-auto">
                    <div class="px-0">
                        <label class="form-label" for="">(1) Número de cuenta bancaria: </label>
                    </div>
                    <input class="form-control" type="text" placeholder="Ejemplo: 192-11303551-0-27" />
                    <div class="px-0 mt-4">
                        <label class="form-label" for="">(2) Ingresa aquí el código de transacción:</label>
                    </div>
                    <input class="form-control mb-4" type="text" placeholder="Ejemplo: 564154d5we4f5egsefw"/>
                </div>
